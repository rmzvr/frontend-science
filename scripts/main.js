...
function validateInputs(input) {
  const set = new Set([{
    ...
    name: "phone",
    regExp: /^(?:\+38)?(?:\(0[0-9][0-9]\)[ .-]?[0-9]{3}[ .-]?[0-9]{2}[ .-]?[0-9]{2}|0[0-9][0-9][ .-]?[0-9]{3}[ .-]?[0-9]{2}[ .-]?[0-9]{2}|0[0-9][0-9][0-9]{7})$/gm,
...
window.addEventListener("scroll", event => {
  ...
  let infoOffsetY = window.scrollY - infographics.getBoundingClientRect().top + infographics.getBoundingClientRect().height;
